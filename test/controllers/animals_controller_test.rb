...
class AnimalsControllerTest < ActionController::TestCase
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post :create, animal: { age: @animal.age, name: @animal.name, race: @animal.race, weight: @animal.weight }
    end
  ...
  test "should update animal" do
    patch :update, id: @animal, animal: { age: @animal.age, name: @animal.name, race: @animal.race, weight: @animal.weight }
    assert_redirected_to animal_path(assigns(:animal))
  end
